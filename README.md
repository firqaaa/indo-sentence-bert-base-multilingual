...
This model covers **7** indonesian local languages comparison, including **javanese**, **sundanese**, **balinese**, **banjarnese**, **minangkabau**, **acehnese**, and **melayu**
...
`torch.utils.data.dataloader.DataLoader` of length 18967 with parameters:
```
